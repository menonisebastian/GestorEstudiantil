...
interface TareaRepository {
    ...
    suspend fun crearTarea(tarea: Tarea, fileData: ByteArray?, fileName: String?): String
    suspend fun editarTarea(tarea: Tarea, fileData: ByteArray?, fileName: String?): String
    ...
    suspend fun realizarEntrega(entrega: Entrega, fileData: ByteArray, fileName: String)
