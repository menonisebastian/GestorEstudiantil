...
val listaEvaluaciones = listOf(
    Evaluacion("1", "UD1", 8.0, "estudiante_1", "asignatura_1", TipoEvaluacionEnum.Examen, listOf("M1", "M2")),
    Evaluacion("2", "UD2", 7.5, "estudiante_1", "asignatura_1", TipoEvaluacionEnum.Practica, listOf("M3")),
    Evaluacion("3", "UD3", 9.0, "estudiante_1", "asignatura_1", TipoEvaluacionEnum.Exposicion, listOf("M4")),
    Evaluacion("4", "TFG", 10.0, "estudiante_1", "asignatura_1", TipoEvaluacionEnum.Proyecto, listOf("Todos los módulos"))
)
